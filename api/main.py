...
app = FastAPI(
    ...
    description=(
        "주소를 좌표·일사량·풍속·지형·지적도·건축물·전력망 Feature로 변환하고 "
        "최신 결과를 CSV와 GeoJSON/GPKG에 저장합니다."
    ),
    version="1.0.0",
    lifespan=lifespan,
)
...
async def preprocess_file(
    file: Annotated[
        UploadFile,
        File(description="address 또는 주소 컬럼이 있는 CSV/XLSX/XLS 파일"),
    ],
